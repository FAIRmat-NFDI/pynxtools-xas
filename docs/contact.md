...
NOMAD, `pynxtools`, and `pynxtools-xas` are open source project that warmly welcome community projects, contributions, suggestions, bug fixes, and constructive feedback. `pynxtools` is build mainly within FAIRmat Area B - Experiment.
...
- Open an issue on [GitHub](https://github.com/FAIRmat-NFDI/pynxtools-xas/issues)
